...
export default async function StartupsPage() {
  ...
  return (
    <div>
      <div className="mb-8"><p className="font-mono text-xs uppercase tracking-[0.18em] text-primary">Company directory</p><h1 className="mt-2 text-3xl font-semibold tracking-[-0.05em]">Recently raised</h1><p className="mt-2 text-sm text-muted-foreground">Search every tracked company and inspect the evidence behind each round.</p></div>
